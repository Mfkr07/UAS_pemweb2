                ...
                <form method="POST" action="{{ route('admin.assets.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-2 md:col-span-1">
                            ...
                            <input id="name" class="mt-2 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm bg-white/50 backdrop-blur-sm" type="text" name="name" value="{{ old('name') }}" required autofocus />
                            @error('name')
                        ...
                        <div class="col-span-2 md:col-span-1">
                            ...
                            <input id="acquisition_date" class="mt-2 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm bg-white/50 backdrop-blur-sm" type="date" name="acquisition_date" value="{{ old('acquisition_date') }}" />
                        ...
                        <div class="col-span-2">
                            ...
                            <input id="location" class="mt-2 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm bg-white/50 backdrop-blur-sm" type="text" name="location" value="{{ old('location') }}" />
                            @error('location')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="col-span-2">
                            ...
                            <textarea id="description" class="mt-2 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm bg-white/50 backdrop-blur-sm" name="description" rows="3">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <!-- Photo -->
                        <div class="col-span-2">
                            <label for="photo" class="block font-medium text-sm text-gray-700">Foto Aset (Opsional)</label>
